...
public class UpdateNormalBossCreep {
	
	public UpdateNormalBossCreep(Game td, long creepdelay){
		//update all the creeps with their new position 

        if(System.nanoTime() - creepdelay > Creep.speedOfCreeps("normalboss")){
        	ArrayList<Creep> toRemove = new ArrayList<Creep>();
            for(Creep creep : td.normalBoss){ 
            ...
            toRemove = null;
            td.normalbosscreepdelay = System.nanoTime(); 
        }
	}
