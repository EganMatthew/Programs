...
public class UpdateFastCreeps {
	
	public UpdateFastCreeps(Game td, long creepdelay){
		//update all the creeps with their new position 

        if(System.nanoTime() - creepdelay > Creep.speedOfCreeps("fastcreep")){
        	
        	ArrayList<Creep> toRemove = new ArrayList<Creep>();
            for(Creep creep : td.fastCreep){
            ...
            toRemove = null;
            td.fastcreepdelay = System.nanoTime();
        }
	}
