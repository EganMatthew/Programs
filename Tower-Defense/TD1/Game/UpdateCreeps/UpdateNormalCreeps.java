...
public class UpdateNormalCreeps {
	
	public UpdateNormalCreeps(Game td, long creepdelay){
		//update all the creeps with their new position 

        if(System.nanoTime() - creepdelay > Creep.speedOfCreeps("normalcreep")){
        	ArrayList<Creep> toRemove = new ArrayList<Creep>();
            for(Creep creep : td.normalCreep){ 
            ...
            toRemove = null;
            td.normalcreepdelay = System.nanoTime(); 
        }
	}
